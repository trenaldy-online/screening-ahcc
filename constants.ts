import { Question, CancerType } from "./src/types";
...
export const CANCER_TYPES: CancerType[] = [
  ...
  {
    id: "kolorektal_pria",
    label: "Kanker Kolorektal (Usus Besar)",
    gender: "male",
  },
  ...
  {
    id: "leher_rahim_wanita",
    label: "Kanker Leher Rahim (Serviks)",
    gender: "female",
  },
  { id: "ovarium_wanita", label: "Kanker Ovarium", gender: "female" },
  {
    id: "kolorektal_wanita",
    label: "Kanker Kolorektal (Usus Besar)",
    gender: "female",
  },
...
const BASE_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "s3",
        label: "Perokok pasif (sering terpapar)",
        value: "Perokok pasif",
      },
      {
        id: "s4",
        label: "Mantan perokok (sudah berhenti)",
        value: "Mantan perokok",
      },
    ],
    followUp: {
...
export const getQuestionsForCancer = (cancerId: string): Question[] => {
  ...
  if (cancerId.includes("paru")) {
    specificQuestion = {
      ...
      options: [
        ...
        {
          id: "p2",
          label: "Batuk lama (>2 minggu) tidak sembuh",
          value: "Batuk kronis",
        },
        {
          id: "p3",
          label: "Napas pendek / sesak saat aktivitas ringan",
          value: "Sesak napas",
        },
      ],
      followUp: {
    ...
    specificQuestion = {
      ...
      options: [
        ...
        {
          id: "b3",
          label: "Perubahan kulit (kerut/kemerahan) atau puting",
          value: "Perubahan fisik",
        },
      ],
      followUp: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                id: "bd4",
                label: "Kaku / Menempel di dalam (Fixed)",
                value: "Fixed",
              },
            ],
          },
    ...
    specificQuestion = {
      ...
      options: [
        ...
        {
          id: "c2",
          label: "Berubah-ubah (Sembelit lalu Diare)",
          value: "Berubah pola",
        },
        ...
        questions: [
          {
            ...
            options: [
              ...
              {
                id: "kd2",
                label: "Merah gelap bercampur feses",
                value: "Merah gelap",
              },
              {
                id: "kd3",
                label: "Hitam pekat (seperti aspal)",
                value: "Hitam/Melena",
              },
              {
                id: "kd4",
                label: "Tidak yakin/Tidak melihat",
                value: "Tidak yakin",
              },
            ],
          },
    ...
    specificQuestion = {
      ...
      options: [
        ...
        {
          id: "g2",
          label: "Ada keluhan ringan (hilang timbul)",
          value: "Ringan",
        },
  ...
  const finalOpenQuestion: Question = {
    ...
    type: "text",
    placeholder:
      "Contoh: Demam naik turun setiap malam, keringat dingin, dll...",
  };
...
export const DISCLAIMER_TEXT =
  "Hasil ini dihasilkan oleh AI sebagai screening awal dan BUKAN merupakan diagnosis medis. Selalu konsultasikan kondisi kesehatan Anda dengan dokter.";
